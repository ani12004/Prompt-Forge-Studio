...
import { Sparkles, History, Settings, Home, LogOut, Bell, Key } from "lucide-react"
            ...
            <aside className="w-16 md:w-64 border-r border-white/5 bg-white/[0.02] backdrop-blur-xl flex flex-col justify-between p-4 z-20 relative">
                <div className="flex flex-col gap-8">
                    ...
                    <nav className="flex flex-col gap-2 pt-4">
                        ...
                        <Link href="/studio/keys" className="flex items-center gap-3 p-3 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all duration-200">
                            <Key className="h-5 w-5" />
                            <span className="hidden md:block font-medium">API Keys</span>
                        </Link>
